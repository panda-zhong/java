...
<html>
	...
	<head>
		...
		<script type="text/javascript" charset="utf-8" src="/basic/html/ueditor/lang/zh-cn/zh-cn.js"></script>
		<style type="text/css">
			p img {
				width: 100px;
				height: 100px;
...
author:panda
computer:@Berenice
createTime:2018年8月11日 上午11:04:04
-->
	...
	<body>
		...
		<form id="newsForm" action="#" method="post" enctype="multipart/form-data">
			<p>
				标题：
				<input type="text" name="newsTitle" id="newsTitle" value="" />
			</p>
			<p>
				作者：
				<input type="text" name="newsAuthor" id="newsAuthor" value="${NEWSMAKERINSESSION.name} " />
			</p>
			<p>
				新闻种类：
				<select name="newsKind">
			...
			<p>
				标题图片：
				<img src="http://p2.so.qhimgs1.com/bdr/_240_/t01643f3ef65a647be2.jpg" alt="加载失败" id="img">
	...
	<script type="text/javascript">
		...
		$("#finish").on('click', function() {
			...
			newsForm.action = "${pageContext.request.contextPath}/newsMaker/news/addToDraft";
			newsForm.submit()
			//			$.ajax({
			//				type: "post",
			//				url: "${pageContext.request.contextPath}/newsMaker/news/addHtml",
			//				data: {
			//					"news": innerText,
			...
			//					setTimeout(function() {
			//						newsForm.submit()
			//						window.location.href = "${pageContext.request.contextPath}/newMaker/login/index";
			//					}, 1500)
			//				},
			//				async: true
			//			});
