				...
				<div class="span10">
					...
					<div class="main-area dashboard">
						<div class="alert alert-info">
							...
							<h4 class="alert-heading">提示</h4> 此处为所有用户新闻数目
							...
							<div class="span10 ">
								<div class="slate">
									...
									<div class="page-header">
										<h2><i class="icon-signal pull-right"></i>新闻统计</h2>
									</div>
	...
	<script type="text/javascript">
		$(document).on('ready', function() {
			...
			function getCommentSize() {
				$.ajax({
					type: "get",
					url: "${pageContext.request.contextPath}/manage/statistics/getNewsSizeByMonth?year=" + thisYear,
					dataType: "json",
