		...
		<div class="main-area dashboard">
						<c:if test="${ALLUSERINFOINSESSION.size()>0}">
							<div class="alert alert-info">
								...
								<h4 class="alert-heading">提示</h4> 此处为所有申请了新闻发布员账号信息
						...
						<c:if test="${ALLUSERINFOINSESSION.size()<=0}">
							<div class="alert alert-error">
								<a class="close" data-dismiss="alert" href="#">x</a>
								<h4 class="alert-heading">提示</h4> 暂时没有任何新闻发布员
						...
						<div class="row ">
							...
							<div class="span10 ">
								...
								<div class="slate ">
									...
									<c:if test="${ALLNEWSMAKERINFOINSESSION.size()>0}">
										<table class="orders-table table">
											...
											<tbody>
												...
												<c:forEach items="${ALLNEWSMAKERINFOINSESSION}" var="user">
													<tr id="user${user.account}">
														...
														<td class="actions">
															<a class="btn btn-small btn-danger disableUser" id="${user.account}" data-toggle="modal" href="${pageContext.request.contextPath}/manage/manageAccount/disableNewsMakerAccount?account=${user.account}">停用</a>
															<a class="btn btn-small btn-primary enableUser" id="${user.account}" href="${pageContext.request.contextPath}/manage/manageAccount/enableNewsMakerAccount?account=${user.account}">恢复</a>
														</td>
													</tr>
												</c:forEach>
